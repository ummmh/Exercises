...
Changed 3 references to all_calculations to all_calc_list
(to match 10_assembled converter)
Changed the name of the calc_history_button to history_button
Added the lambda command
Disabled the history button if nothing in the all_calc_list
"""
